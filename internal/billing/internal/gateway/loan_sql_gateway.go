...
func NewLoanSQLGateway(
	...
	return &LoanSQLGateway{
		...
		loanTableName:           "loan",
		loanInvestmentTableName: "loan_schedule",
		userTableName:           "customers",
	}
}

func (r *LoanSQLGateway) GetLoanSchedule(ctx context.Context, loanID uint64) (*sqlentity.LoanSchedule, error) {

	return nil, nil
}

func (r *LoanSQLGateway) InsertLoans(ctx context.Context, in sqlentity.Loan) error {
